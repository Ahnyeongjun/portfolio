  ...
  return (
    <div className="space-y-8 text-muted-foreground leading-relaxed">
      ...
      <div className="space-y-2">
        ...
        {/* 2. TCD 전/후 비교 패널 자동 구성 */}
        <AccordionSection
          title="변화탐지(TCD) 전/후 비교 패널 자동 구성"
          hint="선택한 영상 1장으로 이전 시점 영상을 자동 매칭해 페어링"
          module="inops-das"
        >
          <p>
            시계열 변화탐지 분석 화면은 여러 위성영상을 그리드 패널에 나눠 담아 비교합니다.
            기존에는 분석관이 비교하고 싶은 전/후 영상을 각각 직접 선택해야 했는데, 변화탐지의
            특성상 결국 &ldquo;같은 지역의 최신 영상과 그 이전 시점 영상&rdquo;을 짝지어 보는
            경우가 대부분이었습니다.
          </p>
          <p>
            변화탐지(TCD) 모드에서는 분석관이 영상을 <Highlight>하나만</Highlight> 선택해도,
            해당 영상의 식별자에서 촬영 시점 값을 파싱해 <Highlight>이전 시점의 영상 ID를
            역산</Highlight>하고, 두 영상을 각각 전/후 패널에 자동으로 배치하도록 만들었습니다.
            일반 모드(TCD가 아닌 다중 비교)는 기존처럼 선택한 영상들을 촬영일 기준으로 정렬해
            패널 개수만큼 배치하고, 남는 영상은 미할당 대기 목록으로 분리하는 로직을 그대로
            유지했습니다.
          </p>
        </AccordionSection>
