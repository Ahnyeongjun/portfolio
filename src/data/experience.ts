...
export const activities: ActivityItem[] = [
  {
    ...
    description: '수강생 6명 대상 백엔드 멘토링 - PR 리뷰, REST API 설계 원칙 지도 및 DDD 기반 도메인 설계를 TDD로 검증하는 실습 진행, AWS 환경에 GitHub Actions CI/CD로 배포',
  },
  {
  ...
  },
  {
    ...
    description: '4개 기수 참여 - 9기 백엔드(모먼티어), 10기 프론트엔드(축지법), 11기 PM·프론트엔드(위딩), 앱 4기 백엔드(Mapin), NCP(네이버클라우드플랫폼) 환경에 배포',
  },
  {
    title: '항해99 백엔드코스 9기',
    type: '교육',
    period: '2025.07 ~ 2025.09',
    description: '상위 10% 수료 - TDD·이벤트 드리븐 설계 첫 경험, k6 부하 테스트로 목표 TPS 달성 검증, 토스 사례로 동기·비동기 아키텍처 비교 분석, 코레오그래피 사가 패턴 학습 및 실습, 온프레미스 환경에 Docker Compose로 배포·GitHub Actions CI 구성',
  },
  {
    title: 'AI 커리어스쿨',
    type: '교육',
