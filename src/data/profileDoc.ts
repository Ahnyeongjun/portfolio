...
export const PROFILE = {
  ...
  summary: [
    {
      head: "폐쇄망 배포, 에러를 0으로",
      body: "외부 기관의 폐쇄망에 납품·배포하는 환경이라, 한 번 터진 에러는 곧바로 손볼 수 없어 처음부터 나지 않게 만드는 것이 중요했습니다. 모놀리식을 MSA로 분리해 한 서비스의 장애가 전체로 번지지 않게 격리하고, Salt 폴링을 RabbitMQ ack/nack·DLQ로 바꿔 노드가 재시작돼도 작업 유실이 0건이 되게 했으며, k6 부하테스트로 병목을 미리 잡아 에러율을 11%에서 0%로 낮췄습니다. 그렇게 사내 에러 문의를 주 2~3회에서 월 1회로 줄였습니다.",
    },
    {
      head: "최적화는 백엔드 밖에도 있었다",
      body: "제대로 최적화하려면 백엔드만으로는 부족하다는 걸 느꼈습니다. 무겁게 느려지던 가시화 화면은 렌더링 방식을 프론트(Next.js·FSD)에서 다시 잡아 사용자 체감 속도를 끌어올렸고, GPU 위에서는 모델을 직접 서빙하고 GPUShare로 자원을 나눠 처리량을 하루 200건에서 3,000건까지 늘렸습니다.",
    },
    {
      head: "반복은, 재사용으로",
      body: "프로젝트를 거듭하며 반복되는 작업이 쌓이는 것을 보고, 다시 만들지 않아도 되는 구조를 고민하기 시작했습니다. 서비스를 재사용 가능한 모듈로 분리하고, Git·캘린더·HR 업무와 ML 실험을 자동화하는 사내 에이전트를 만들어 반복을 시스템으로 흡수했고, 동시 운영 가능한 서비스를 1개에서 5개로 늘렸습니다.",
    },
  ],
  closing: "결국 좋은 백엔드는 한 번 잘 만들어 두고두고 안정적으로 돌아가는 구조라고 믿습니다. 이 경험을 더 큰 트래픽과 더 복잡한 운영 환경에서 이어가고 싶습니다.",
