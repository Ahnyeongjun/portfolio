...
export const PROFILE = {
  ...
  summary: [
    {
      head: "폐쇄망 배포, 에러를 0으로",
      body: "외부 기관의 폐쇄망에 납품·배포하는 환경에서, 한 번 터진 에러는 곧바로 손볼 수 없어 처음부터 줄이는 데 집중했습니다. k6 부하테스트와 테스트 클러스터에서의 통합 테스트로 배포 전에 문제를 미리 잡아 에러율을 11%에서 0%로 낮추고 잘못된 배포를 사전에 걸러냈으며, MSA 전환으로 재배포를 월 10건에서 1건으로 줄였습니다. 그 결과 사내 에러 문의도 주 2~3회에서 월 1회로 줄었습니다.",
    },
    {
      head: "최적화는 백엔드 밖에도 있었다",
      body: "다뤄온 도메인은 백엔드이지만, 최적화는 그 밖에도 있었습니다. 렌더링 방식을 프론트(Next.js·FSD)에서 다시 잡고, 통신 방식을 바꾸고, 모델을 직접 개발하고, GPUShare로 자원을 나누며 — 프론트부터 외부 AI 서비스까지 시스템 경계를 넘어 서비스 전체의 최적화를 목표로 했습니다.",
    },
    {
      head: "반복은, 재사용으로",
