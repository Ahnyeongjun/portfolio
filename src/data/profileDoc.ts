  ...
  summary: [
    {
      ...
      body: "한국항공우주연구원(KARI)·국가보안기관·NIPA 등 인터넷 접근성부터 규모까지 서로 다른 기관을 대상으로 인프라를 매번 새로 설계했습니다. 온프레미스 클러스터 구축, 에어갭 환경의 무중단 운영, MSA 전환에 따른 네트워킹·시크릿·배포·관측성 고도화까지 인프라 전 영역을 담당했습니다.",
    },
    {
