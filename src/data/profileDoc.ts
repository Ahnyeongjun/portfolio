      ...
      blocks: [
        {
          ...
          oneliner: "주간보고·공수 입력 매주 30~60분 수작업 → FastMCP 8개 도구 구현 → 단일 명령으로 완료, 팀 공유",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          oneliner: "처리량 한계인데 GPU 90% 유휴 → GPUShare 분할 + ONNX 독립 배포 → GPU 4장 70파드, 일 200건→3,000건",
        },
        {
          label: "메타데이터 API 성능",
          ...
          oneliner: "PostGIS 전수 연산으로 메타데이터 API 38초 응답 → 조건부 실행·페이징·Redis 캐싱 → 159ms, 에러율 11.22%→0%",
        },
      ],
    },
  ] as DocProject[],
