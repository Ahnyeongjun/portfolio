    ...
    groups: [
      ...
      },
      {
        ...
        items: [
          ...
          { text: "신규 노드 추가 시 OS·K8s 사전 준비(스왑 비활성화·커널 모듈·containerd 설치 등)를 Ansible 플레이북으로 자동화 - 수동 설정 편차 제거 (KARI)" },
      ...
      },
      {
        ...
        items: [
          ...
          { text: "TTL이 필요한 휘발성 데이터·API/쿼리 응답 캐싱을 위해 Redis를 Helm으로 K8s에 배포·운영 - RDB 스냅샷으로 재시작 시에도 데이터 유지 (KARI)" },
        ],
      },
      {
        title: "업무 자동화",
