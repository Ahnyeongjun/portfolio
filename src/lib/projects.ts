...
export const projects: Project[] = [
  ...
  },
  {
    ...
    achievements: [
      ...
      "[장애 사전 감지] 인터넷이 차단된 환경이라 장애를 사후에야 인지하는 구조 → Zabbix 커스텀 대시보드로 호스트·서비스 모니터링 체계 직접 구축 - 외부 레퍼런스 없이 시스템 하부 레이어까지 추적하는 트러블슈팅 역량과 장애 사전 감지 체계 확보",
