...
export const projects: Project[] = [
  {
    ...
    titleEn: "NIPA RabbitMQ-based Change Detection AI Platform",
    description: "두 시점의 위성 영상을 비교해 지표 변화를 AI로 탐지하는 변화탐지 플랫폼. NIPA(정보통신산업진흥원) 지원 사업.",
    descriptionEn: "Satellite imagery platform that detects surface changes by comparing two temporal images using AI. NIPA (National IT Industry Promotion Agency) funded project.",
