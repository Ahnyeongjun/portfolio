...
description: "ISMS-P가 뭔지, 증적이 뭔지부터 KISA 인증기준 인프라 관련 항목을 매핑표로 정리하고, NetworkPolicy·TLS·SealedSecret·Loki 보존 정책을 항목별 증적으로 연결하는 절차, 선택 확장인 OpenBao+ESO 시크릿 감사 로그까지."
date: "2026-07-21"
category: "Security"
tags: ["ISMS-P", "NetworkPolicy", "보안 컴플라이언스", "Kubernetes", "OpenBao"]
