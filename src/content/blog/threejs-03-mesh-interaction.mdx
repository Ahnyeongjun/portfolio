...
description: "3D 공간의 객체를 클릭하여 선택하고, TransformControls로 이동하는 기능을 구현한다."
date: "2025-02-05"
category: "Three.js"
...
3D 공간의 객체를 클릭하여 선택하고, TransformControls로 이동하는 기능이다.

---

## Raycasting 이해

Three.js에서 "3D 객체를 클릭한다"는 것은 **Raycasting**이다.
...
겹쳐진 메쉬들이 있을 때, 클릭 이벤트가 뒤에 있는 메쉬까지 전파된다.
...
Drei의 `TransformControls`를 사용한다.
...
TransformControls로 객체를 드래그하면 OrbitControls도 반응하여 카메라가 같이 움직인다.
...
이동한 위치를 Zustand에 저장하여 분해 효과와 결합한다.
